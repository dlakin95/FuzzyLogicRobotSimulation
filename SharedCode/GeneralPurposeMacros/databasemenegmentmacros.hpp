...
#define DB_GET_SUPER_CLASS_NUMB_OF_PARAMS(objType) objType::getSuperClassNumbOfParameters()
...
#define DB_OBJECT_GET_PARAM_ENUM_CALL_BASE(paramRules, objType, baseObjType) {if(paramRules.param < objType::getSuperClassNumbOfParameters())   return baseObjType::getParam(paramRules);   else    paramRules.param -= objType::getSuperClassNumbOfParameters();}
#define DB_OBJECT_GET_PARAM_VOID_PTR_CALL_BASE(paramRules, value, objType, baseObjType) {if(paramRules.param < objType::getSuperClassNumbOfParameters())  return baseObjType::getParam(value, paramRules); else    paramRules.param -= objType::getSuperClassNumbOfParameters();}
#define DB_OBJECT_SET_PARAM_VOID_PTR_CALL_BASE(paramRules, value, objType, baseObjType) {if(paramRules.param < objType::getSuperClassNumbOfParameters())  return baseObjType::setParam(value, paramRules); else    paramRules.param -= objType::getSuperClassNumbOfParameters();}
#define DB_OBJECT_SET_PARAM_STR_CALL_BASE(paramRules, value, objType, baseObjType) {if(paramRules.param < objType::getSuperClassNumbOfParameters())  return baseObjType::setParam(value, paramRules); else    paramRules.param -= objType::getSuperClassNumbOfParameters();}
#define DB_OBJECT_COMPARE_PARAMS_CALL_BASE(paramRules, value, objType, baseObjType) {if(paramRules.param < objType::getSuperClassNumbOfParameters())  return baseObjType::compareParams(value, paramRules); else    paramRules.param -= objType::getSuperClassNumbOfParameters();}
...
#define DB_OBJECT_IS_PARAM_OPTIONAL_CALL_BASE(param, objType, baseObjType) {if(param < objType::getSuperClassNumbOfParameters()) return baseObjType::isParamOptional(param); else param -= objType::getSuperClassNumbOfParameters(); return (*(objType::optionality + param));}
#define DB_OBJECT_IS_PARAM_OBJECT_CALL_BASE(param, objType, baseObjType) {if(param < objType::getSuperClassNumbOfParameters()) return baseObjType::isParamObject(param); else param -= objType::getSuperClassNumbOfParameters(); return (*(objType::paramIsObject + param));}
#define DB_OBJECT_GET_PARAM_NAME_CALL_BASE(param, objType, baseObjType) {if(param < objType::getSuperClassNumbOfParameters()) return baseObjType::getParamName(param); else param -= objType::getSuperClassNumbOfParameters();}
...
#define DB_OBJECT_IS_INITIALIZED_BOOL(objType) if(!initializedParameters || (paramRules.initialized = (*(initializedParameters + objType::getSuperClassNumbOfParameters() + paramRules.param))) == false)  return false;
#define DB_OBJECT_IS_INITIALIZED_QSTRING(objType) if(!initializedParameters || (paramRules.initialized = (*(initializedParameters + objType::getSuperClassNumbOfParameters() + paramRules.param))) == false)  return QString();
...
#define DB_OBJECT_BASE_CLASS_METHOD_GET_NUMB_OF_PARAMETERS(numbOfParameters) virtual inline uint getNumbOfParameters(){return numbOfParameters;}
#define DB_OBJECT_BASE_CLASS_METHOD_GET_SUPER_CLASS_NUMB_OF_PARAMETERS virtual inline uint getSuperClassNumbOfParameters(){return 0;}
...
#define DB_OBJECT_METHOD_GET_NUMB_OF_PARAMETERS(curClassNumbOfParameters, curClassName) virtual inline uint getNumbOfParameters()override{return curClassNumbOfParameters + DB_GET_SUPER_CLASS_NUMB_OF_PARAMS(curClassName);}
#define DB_OBJECT_METHOD_GET_SUPER_CLASS_NUMB_OF_PARAMETERS(superClassName) virtual inline uint getSuperClassNumbOfParameters()override{return superClassName::getNumbOfParameters();}
...
#define DB_OBJECT_BASE_CLASS_PARAMETERS_MENEGMENT_DEFINITIONS(curClassParameterEnumName, curClassNumbOfParameters)      DB_OBJECT_BASE_CLASS_METHOD_GET_REAL_PARAM(curClassParameterEnumName) \
                                                                                                                        DB_OBJECT_BASE_CLASS_METHOD_GET_NUMB_OF_PARAMETERS(curClassNumbOfParameters)    \
...
#define DB_OBJECT_PARAMETERS_MENEGMENT_DEFINITIONS(curClassName, superClassName, curClassParameterEnumName, curClassNumbOfParameters,  superClassNumbOfParameters)             DB_OBJECT_METHOD_GET_REAL_PARAM(curClassParameterEnumName, superClassName, superClassNumbOfParameters) \
                                                                                                                                                                                DB_OBJECT_METHOD_GET_NUMB_OF_PARAMETERS(curClassNumbOfParameters, curClassName)    \
                                                                                                                                                                                DB_OBJECT_METHOD_GET_SUPER_CLASS_NUMB_OF_PARAMETERS(superClassName)
// Types
